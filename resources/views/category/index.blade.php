...
<head>
    ...
    <title>{{ $courses->first()->category->categoryName ?? 'Category'  }} - Edu Fun</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1>{{ $courses->first()->category->categoryName ?? 'Category' }}</h1>
        <p class="text-muted">Explore courses in {{ $courses->first()->category->categoryName ?? 'Category' }}</p>
    </div>

    <!-- Daftar Courses Berdasarkan Category -->
    <div class="container mt-4">
            ...
            <div class="row mb-4 p-3 border rounded">
                ...
                <div class="col-md-9 d-flex flex-column justify-content-between">
                    ...
                    <div class="text-end">
                        ...
                        <!-- <a href="#" class="btn btn-primary btn-sm" style="background-color: #003366; border-radius: 15px;">Read more</a> -->
                    </div>
                </div>
            </div>
        @endforeach
